...
contract InvoiceDiscounting {
  ...
  function fundWallet(string memory customerId, address customer, uint256 amount) public restricted returns(bool) {
    ...
    require(amount < usdcToken.balanceOf(owner) , "Funding this amount is not possible at the moment. Please try again later."); //Beneficiary should have enough funds 
    ...
    usdcToken.transferFrom(owner, customer, amount);
