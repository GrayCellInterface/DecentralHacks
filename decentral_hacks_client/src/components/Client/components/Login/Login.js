    ...
    const renderModalContent = () => {
        if (props.openRegister) {
            if (props.openSuccess) {
                return (
                    <>
                        ...
                        <Container>
                            ...
                            <Row className="justify-content-md-center">
                                <Col md="auto">
                                    <button className="me-btn inner-text" type="submit" onClick={props.handleBackToLogin}>
                                        Login Now
                                    </button>
                                </Col>
                            </Row>
                ...
                return (
                    <>
                        <Form>
                            ...
                            <button className="me-btn inner-text" type="submit" onClick={props.handleVerify}>
                                Verify
                            </button>
                        </Form>
                    </>
                ...
                if (props.openStep2) {
                    let district;
                    if (props.billingValues['country'] === 'US' || props.billingValues['country'] === 'CA') {
                        district = (
                            <>
                                <Form.Group className="mb-3" controlId="formBasicCity">
                                    <Form.Label>District</Form.Label>
                                    <Form.Control value={props.billingValues['district']} onChange={props.handleBillingChange('district')} placeholder="Enter 2-letter district code" />
                                    {props.errors['districtError'] === "" ? <></> : <div className='error-msg'>{props.errors['districtError']}</div>}
                                </Form.Group>
                            </>
                        )
                    } else {
                    ...
                    return (
                        <>
                            <Form>
                                <Form.Text className="text-muted" style={{ fontSize: "18px", display: 'block', marginBottom: "20px" }}>
                                    <b>Billing Details: </b>
                                </Form.Text>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicCity">
                                    ...
                                    <Form.Control value={props.billingValues['city']} onChange={props.handleBillingChange('city')} placeholder="Enter your city" />
                                    {props.errors['cityError'] === "" ? <></> : <div className='error-msg'>{props.errors['cityError']}</div>}
                                </Form.Group>
                                {district}
                                <Form.Group className="mb-3" controlId="formBasicAddress">
                                    <Form.Label>Address</Form.Label>
                                    <Form.Control value={props.billingValues['address']} onChange={props.handleBillingChange('address')} placeholder="Enter your residential address" />
                                    {props.errors['addressError'] === "" ? <></> : <div className='error-msg'>{props.errors['addressError']}</div>}
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="formBasicPostal">
                                    <Form.Label>Postal Code</Form.Label>
                                    <Form.Control value={props.billingValues['postalcode']} onChange={props.handleBillingChange('postalcode')} placeholder="Enter postal code" />
                                    {props.errors['postalError'] === "" ? <></> : <div className='error-msg'>{props.errors['postalError']}</div>}
                                </Form.Group>
                                <button className="me-btn inner-text" type="submit" style={{ float: 'left', marginRight: '20px' }} onClick={props.handleRegistration}>
                                    Register
                                </button>
                                <button className="me-btn inner-text" style={{ float: 'right', marginLeft: '-20px' }} onClick={props.handleBackToStep1}>
                                    Back
                                </button>
                                {
                        ...
                        <>
                            <Form>
                                <Form.Group className="mb-3" controlId="formBasicName">
                                    ...
                                    <Form.Control value={props.registerValues['name']} onChange={props.handleRegisterChange('name')} placeholder="Enter your full name" />
                                ...
                                <button className="me-btn inner-text" type="submit" style={{ float: 'left', marginRight: '20px' }} onClick={props.handleGoToStep2}>
                                    Next
                                </button>
                                <button className="me-btn inner-text" style={{ float: 'right', marginLeft: '-20px' }} onClick={props.handleBackToLogin}>
                                    Back
                                </button>
                            </Form>
                        </>
            ...
            return (
                <>
                    <Form>
                        ...
                        <button className="me-btn inner-text" type="submit" onClick={props.handleLogin} style={{ marginRight: '20px' }}>
                            Login
                        </button>
                        {
